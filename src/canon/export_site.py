...
Pages generated (the homepage is generated too, in the same design):
  ...
  papers.html            all 198 papers, honest about scored-vs-seed status
...
<div class="statgrid">
  ...
  <div class="stat"><b>198</b><span>seed papers, 1943-2025</span></div>
...
def page_papers(papers: dict, scored: set) -> str:
    rows = ['<p class="note">All 198 seed papers. <b>Seed status means candidacy, not canonical '
...
def page_data(release: dict, coverage: dict) -> str:
    body = [
        ...
        '<li><a href="audit/seeds/papers.json">papers.json</a> &middot; <a href="audit/seeds/papers.csv">papers.csv</a>, 198 papers</li>'
...
def page_search() -> str:
    body = (
        '<p class="note">Search the whole corpus: 573 books, 198 papers, and the voices, '
